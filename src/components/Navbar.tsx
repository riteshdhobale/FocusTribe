                ...
                <DropdownMenu.Portal>
                  ...
                  >
                    <DropdownMenu.Item asChild>
                      <Link
                        to="/profile"
                        className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium outline-none cursor-pointer transition-colors"
                    ...
                    <DropdownMenu.Item asChild>
                      <button
                        onClick={signOut}
                        className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm font-medium outline-none cursor-pointer transition-colors text-red-400"
                        onMouseEnter={(e) =>
