...
export function MatchList({ matches, selectedId, myId, onSelect }: Props) {
  ...
  return (
    <div
      className="h-full flex flex-col border-r border-[color:var(--hairline)]"
    ...
    >
      ...
      {matches.filter((m) => !m.lastMessage).length > 0 && (
        <div className="px-5 py-3 border-b border-[color:var(--hairline)]">
          <div className="text-[10px] uppercase tracking-widest text-[color:var(--text-muted)] mb-2">
            New Matches
          </div>
                ...
                return (
                  ...
                  >
                    <div className="relative">
                      ...
                      {partner.isOnline && (
                        <div
                          className="absolute -bottom-0.5 -right-0.5 w-4 h-4 rounded-full border-2 border-[color:var(--surface)]"
            ...
            return (
              ...
              >
                <div className="relative flex-shrink-0">
                  ...
                  {partner.isOnline && (
                    <div
                      className="absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 rounded-full border-2 border-[color:var(--surface)]"
                      style={{ background: "var(--emerald-live)" }}
                    />
                  )}
                </div>
