        ...
        >
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                <strong>Profile information:</strong> Age, gender, city, college, exam focus, career
                goals, bio, study preferences
              </li>
              <li>
                <strong>Student verification:</strong> College email (.edu/.ac.in) for Campus badge
                verification
              </li>
              <li>
                <strong>Profile photos:</strong> Images you upload for your profile
              </li>
              <li>
                <strong>Messages:</strong> Chat messages sent to matched users
              </li>
              <li>
                <strong>Payment information:</strong> Processed by Razorpay — we do NOT store your
                card details
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>
                <strong>Usage data:</strong> Study hours, streak counts, room participation
              </li>
              <li>
          ...
          <section>
            ...
            <p className="mb-3">
              <strong>We do NOT sell your personal data.</strong> We share information only in these
              limited cases:
            </p>
            <ul className="list-disc pl-6 space-y-1">
              <li>
              ...
              <li>
                <strong>Service providers:</strong> Supabase (database), Razorpay (payments), Jitsi
                (video calls) — these partners process data on our behalf under strict agreements
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>
                Data is stored on Supabase (PostgreSQL) with servers in the Asia-Pacific region
              </li>
              ...
              <li>
                Payment data is handled entirely by Razorpay (PCI DSS compliant) — we never see or
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                <strong>Grievance redressal:</strong> File a complaint with our Data Protection
                Officer
              </li>
            </ul>
            <p className="mt-3">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>
                <strong>Messages:</strong> Deleted when either participant deletes their account
              </li>
              <li>
                <strong>Payment records:</strong> Retained for 7 years as required by Indian tax
                regulations
              </li>
              <li>
                <strong>Reports:</strong> Moderation records may be retained for safety even after
                account deletion
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              communicated via email or in-app notification. The updated policy will be posted on
