      ...
      <div className="max-w-3xl mx-auto px-4 pt-16 pb-24">
        ...
        >
          ...
          <section>
            ...
            <p>
              You may register using your email address or Google account. You are responsible for
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              <li>
                Use the Service for any unlawful purpose or to solicit others to perform unlawful
                acts
              </li>
            ...
            <p className="mt-3">
              Violation of these rules may result in temporary or permanent suspension of your
              account.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li>Prices are shown in your region's currency before checkout</li>
              <li><strong>Monthly (Pro):</strong> auto-renews unless cancelled</li>
              <li><strong>Annual (Campus):</strong> annual billing for verified students</li>
              <li><strong>Weekly Pass:</strong> one-time access, does NOT auto-renew</li>
          ...
          <section>
            ...
            <p>
              We take safety seriously. You can report any user or content that violates these Terms
              using the in-app report button. Reports are reviewed within 24 hours. We reserve the
              right to suspend or terminate accounts that violate our community guidelines without
              prior notice.
            </p>
          </section>
