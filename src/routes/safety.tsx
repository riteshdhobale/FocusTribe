    ...
    <div className="min-h-screen" style={{ background: "var(--bg-main)" }}>
      ...
      <div className="max-w-4xl mx-auto px-4 pt-16 pb-24">
        <div className="text-center mb-16">
          ...
          <h1 className="font-display font-extrabold text-4xl md:text-5xl mb-4" style={{ color: "var(--text-primary)" }}>
            Built for serious people,<br />not chaos
          </h1>
          <p className="text-base max-w-lg mx-auto" style={{ color: "var(--text-muted)" }}>
            StudyDate is designed to help ambitious students connect safely, study effectively, and build meaningful relationships around shared goals.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          <div className="p-6 rounded-2xl border" style={{ borderColor: "var(--hairline)", background: "var(--bg-card)" }}>
            <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-4" style={{ background: "rgba(201,165,78,0.15)" }}>
              <Shield className="w-5 h-5" style={{ color: "var(--rose-accent)" }} />
            </div>
            <h3 className="font-semibold text-base mb-2" style={{ color: "var(--text-primary)" }}>18+ and respectful</h3>
            <p className="text-sm leading-relaxed" style={{ color: "var(--text-secondary)" }}>
              Dating flows are adult-only with clear conduct expectations and profile controls. Zero tolerance for harassment.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl border" style={{ borderColor: "var(--hairline)", background: "var(--bg-card)" }}>
            ...
            <h3 className="font-semibold text-base mb-2" style={{ color: "var(--text-primary)" }}>Academic authenticity</h3>
            <p className="text-sm leading-relaxed" style={{ color: "var(--text-secondary)" }}>
              Profiles emphasize college, goals, and ambition so conversations start with trust and context. Verify with your .edu email.
            </p>
          </div>
          ...
          <div className="p-6 rounded-2xl border" style={{ borderColor: "var(--hairline)", background: "var(--bg-card)" }}>
            ...
            <h3 className="font-semibold text-base mb-2" style={{ color: "var(--text-primary)" }}>Intent-forward matching</h3>
            <p className="text-sm leading-relaxed" style={{ color: "var(--text-secondary)" }}>
              Users declare whether they want study partners, accountability buddies, friends-first chemistry, or meaningful dating.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-8">
          <h2 className="font-display font-bold text-2xl text-center mb-8" style={{ color: "var(--text-primary)" }}>How we protect you</h2>
          ...
          {[
            ...
            <div key={i} className="flex gap-4 p-5 rounded-2xl border" style={{ borderColor: "var(--hairline)", background: "var(--bg-card)" }}>
        ...
        {/* CTA */}
        <div className="text-center mt-16 p-8 rounded-3xl border" style={{ borderColor: "var(--hairline)", background: "var(--bg-card)" }}>
          ...
          <a href="/discover" className="inline-block px-8 py-3.5 rounded-xl text-sm font-semibold" style={{ background: "var(--rose-accent)", color: "#0B1120" }}>
            Start matching →
          </a>
        </div>
      </div>
